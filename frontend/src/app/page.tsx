...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-12 sm:gap-20 pb-20 font-sans mt-8 sm:mt-10 overflow-hidden">
      {/* Hero Section */}
      <section className="relative pt-8 sm:pt-10 pb-8 text-center max-w-4xl mx-auto flex flex-col items-center px-4">
        <motion.div 
